  ...
  return (
    <nav className="bg-black py-6 px-6 md:px-12 flex justify-between items-center relative">
      ...
      >
        ...
        <a target="__blank__" href="https://drive.usercontent.google.com/u/1/uc?id=1159lBNiFjIpf0pm7My2LSInvlmHsvKpV&export=download" className="text-blue-400 hover:text-blue-500 text-2xl" onClick={() => setIsOpen(false)}>Resume</a>
